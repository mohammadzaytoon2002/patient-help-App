...
import 'package:watch3/screen/doctor_screen/logindoctor.dart';
...
import 'package:watch3/screen/profile/about_usdoc.dart';
import 'package:http/http.dart' as http;
import 'package:watch3/screen/profile/profileeditdoc.dart';
import 'package:watch3/screen/profile/setting_pagedoc.dart';
import 'package:watch3/screen/profile/usermanagments.dart';

class MyProfile1doc extends StatefulWidget {
  @override
  _MyProfileState createState() => _MyProfileState();
}

class _MyProfileState extends State<MyProfile1doc> {
  String fullname = "";
  String email = "";
  String? token;
  String? userPicture;
                ...
                child: ClipPath(
                  ...
                  child: AppBar(
                    ...
                    backgroundColor: Color.fromARGB(
                        255, 30, 71, 114), // Your preferred color
                    title: Text(
                      "Profile",
                      style: TextStyle(
                        color: Colors.white,
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ProfileEdite1doc(),
                                  ),
                                );
                              },
                              child: Container(
                      ...
                      ProfileMenu(
                        ...
                        onPress: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SettingsPagedoc()),
                          );
                        },
                      ),
                      ProfileMenu(
                        ...
                        onPress: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => UserManagementPagedoc()),
                          );
                        },
                      ),
                      SizedBox(height: 10),
                      ...
                      ProfileMenu(
                        ...
                        onPress: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AboutUsPagedoc()),
                          );
                        },
                      ),
                      SizedBox(height: 60),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.of(context).pushAndRemoveUntil(
                              MaterialPageRoute(
                                builder: (context) => LoginPagedoctor(),
                              ),
