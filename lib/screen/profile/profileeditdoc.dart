...
class ProfileEdite1doc extends StatefulWidget {
  const ProfileEdite1doc({Key? key}) : super(key: key);

  @override
  State<ProfileEdite1doc> createState() => _ProfileEditeState();
}

class _ProfileEditeState extends State<ProfileEdite1doc> {
  File? _image;
  String? _image2;
  String? _password;
